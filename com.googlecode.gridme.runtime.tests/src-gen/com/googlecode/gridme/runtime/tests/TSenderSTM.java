...
/**
 * This is an implementation of TSender statemachine. 
 * To use it from an active element do the following:
 *
 * <ul>
 * <li>call setStatemachine(new TSenderSTM(this)) from the constructor.</li>
 *
 ...
 */
public class TSenderSTM extends Statemachine {
	...
	public static final int ACTION_getPeriod = 1;
	public static final int ACTION_notFinished = 2;
	public static final int ACTION_isFinished = 3;
	...
	public TSenderSTM(ActiveElement parent) {
		super(parent);
		activeSignal = null;

...
/**
 * This is an implementation of SimpleCluster statemachine. 
 * To use it from an active element do the following:
 *
 * <ul>
 * <li>call setStatemachine(new SimpleClusterSTM(this)) from the constructor.</li>
 *
 ...
 */
public class SimpleClusterSTM extends Statemachine {
	...
	public static final int ACTION_doHourly = 0;
	public static final int ACTION_getScheduleDelay = 1;
	...
	public SimpleClusterSTM(ActiveElement parent) {
		super(parent);
		activeSignal = null;

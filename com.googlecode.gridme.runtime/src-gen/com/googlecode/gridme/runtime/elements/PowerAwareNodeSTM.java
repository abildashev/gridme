...
public class PowerAwareNodeSTM extends Statemachine {
	...
	public static final int ACTION_startTask = 1;
	public static final int ACTION_TaskFinished = 2;
	public static final int ACTION_enterIdle = 3;
	public static final int ACTION_wakeup = 4;
	public static final int ACTION_stopTask = 5;

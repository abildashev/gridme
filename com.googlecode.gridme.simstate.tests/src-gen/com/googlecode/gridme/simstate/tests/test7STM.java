...
/**
 * This is an implementation of test7 statemachine. 
 * To use it from an active element do the following:
 *
 * <ul>
 * <li>call setStatemachine(new test7STM(this)) from the constructor.</li>
 *
 ...
 */
public class test7STM extends Statemachine {
	...
	public test7STM(ActiveElement parent) {
		super(parent);
		activeSignal = null;

...
/**
 * This is an implementation of test5 statemachine. 
 * To use it from an active element do the following:
 *
 * <ul>
 * <li>call setStatemachine(new test5STM(this)) from the constructor.</li>
 *
 ...
 */
public class test5STM extends Statemachine {
	...
	public test5STM(ActiveElement parent) {
		super(parent);
		activeSignal = null;

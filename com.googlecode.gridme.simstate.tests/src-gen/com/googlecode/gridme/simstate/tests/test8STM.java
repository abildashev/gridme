...
/**
 * This is an implementation of test8 statemachine. 
 * To use it from an active element do the following:
 *
 * <ul>
 * <li>call setStatemachine(new test8STM(this)) from the constructor.</li>
 *
 ...
 */
public class test8STM extends Statemachine {
	...
	public static final int ACTION_Aexit = 0;
	public static final int ACTION_Aenter = 1;
	...
	public test8STM(ActiveElement parent) {
		super(parent);
		activeSignal = null;
	...
	private void enterState(int state) throws Exception {
		switch (state) {
			...
			case ST_State1 :
				...
				getParent().action(ACTION_Aenter);

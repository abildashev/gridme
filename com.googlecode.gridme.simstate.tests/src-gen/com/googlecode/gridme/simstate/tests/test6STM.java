...
/**
 * This is an implementation of test6 statemachine. 
 * To use it from an active element do the following:
 *
 * <ul>
 * <li>call setStatemachine(new test6STM(this)) from the constructor.</li>
 *
 ...
 */
public class test6STM extends Statemachine {
	...
	public test6STM(ActiveElement parent) {
		super(parent);
		activeSignal = null;

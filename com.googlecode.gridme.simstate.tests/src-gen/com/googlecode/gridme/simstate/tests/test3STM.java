...
/**
 * This is an implementation of test3 statemachine. 
 * To use it from an active element do the following:
 *
 * <ul>
 * <li>call setStatemachine(new test3STM(this)) from the constructor.</li>
 *
 ...
 */
public class test3STM extends Statemachine {
	...
	public static final String PARAM_trueParam = "trueParam";
	public static final String PARAM_falseParam = "falseParam";

	private int currentState;
	private GSignal activeSignal;
	private boolean isFinished = false;

	public test3STM(ActiveElement parent) {
		super(parent);
		activeSignal = null;
		...
		do {
			...
			switch (currentState) {
				case ST_start :
					...
					if (ConvertUtils
							.makeBooleanValue(getParam(PARAM_trueParam))) {
						leaveState(ST_start);
				...
				case ST_State1 :
					// no signal transition
					if (ConvertUtils
							.makeBooleanValue(getParam(PARAM_falseParam))) {

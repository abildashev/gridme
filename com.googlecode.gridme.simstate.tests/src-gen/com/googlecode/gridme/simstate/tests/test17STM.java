...
/**
 * This is an implementation of test17 statemachine. 
 * To use it from an active element do the following:
 *
 * <ul>
 * <li>call setStatemachine(new test17STM(this)) from the constructor.</li>
 *
 ...
 */
public class test17STM extends Statemachine {
	...
	public test17STM(ActiveElement parent) {
		super(parent);
		activeSignal = null;

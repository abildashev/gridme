...
/**
 * This is an implementation of test15 statemachine. 
 * To use it from an active element do the following:
 *
 * <ul>
 * <li>call setStatemachine(new test15STM(this)) from the constructor.</li>
 *
...
public class test15STM extends Statemachine {
	...
	public test15STM(ActiveElement parent) {
		super(parent);
		activeSignal = null;
	...
	private void enterState(int state) throws Exception {
		switch (state) {
			...
			case ST_receive :
				...
				getParent().action(ACTION_logSignal);

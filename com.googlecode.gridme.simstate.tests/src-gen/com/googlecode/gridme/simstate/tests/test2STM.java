...
/**
 * This is an implementation of test2 statemachine. 
 * To use it from an active element do the following:
 *
 * <ul>
 * <li>call setStatemachine(new test2STM(this)) from the constructor.</li>
 *
 ...
 */
public class test2STM extends Statemachine {
	...
	public test2STM(ActiveElement parent) {
		super(parent);
		activeSignal = null;
		...
		do {
			...
			switch (currentState) {
				case ST_start :
					...
					if (ConvertUtils.makeBooleanValue("true")) {
						leaveState(ST_start);

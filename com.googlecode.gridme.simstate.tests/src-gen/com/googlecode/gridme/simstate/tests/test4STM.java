...
/**
 * This is an implementation of test4 statemachine. 
 * To use it from an active element do the following:
 *
 * <ul>
 * <li>call setStatemachine(new test4STM(this)) from the constructor.</li>
 *
 ...
 */
public class test4STM extends Statemachine {
	...
	public static final int ACTION_trueAction = 0;
	public static final int ACTION_falseAction = 1;
	...
	public test4STM(ActiveElement parent) {
		super(parent);
		activeSignal = null;

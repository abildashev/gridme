...
/**
 * This is an implementation of test10 statemachine. 
 * To use it from an active element do the following:
 *
 * <ul>
 * <li>call setStatemachine(new test10STM(this)) from the constructor.</li>
 *
 ...
 */
public class test10STM extends Statemachine {
	...
	public test10STM(ActiveElement parent) {
		super(parent);
		activeSignal = null;
			...
			case ST_State1 :
				...
				getParent().addTimer(
						new TransitionTimer("t2", ConvertUtils
								.makeLongValue(getParam(PARAM_timer))));
				// set state name

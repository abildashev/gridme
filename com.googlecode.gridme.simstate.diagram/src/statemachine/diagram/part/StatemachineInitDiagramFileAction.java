  ...
  public void run(IAction action)
  {
    ...
    if(diagramRoot == null)
    {
      MessageDialog
          .openError(
              getShell(),
              Messages.StatemachineInitDiagramFileAction_InitDiagramFileResourceErrorDialogTitle,
              Messages.StatemachineInitDiagramFileAction_InitDiagramFileResourceErrorDialogMessage);
      return;
    }
    Wizard wizard = new StatemachineNewDiagramFileWizard(domainModelURI,
        diagramRoot, editingDomain);
    wizard.setWindowTitle(NLS.bind(
        Messages.StatemachineInitDiagramFileAction_InitDiagramFileWizardTitle,

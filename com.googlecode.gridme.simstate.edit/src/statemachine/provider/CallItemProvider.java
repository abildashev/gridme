...
/**
 * This is the item provider adapter for a {@link statemachine.Call} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource		
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Call_actionId_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Call_actionId_feature", "_UI_Call_type"),
         StatemachinePackage.Literals.CALL__ACTION_ID,
         true,
         false,
         false,
  ...
  {
    String label = ((Call)object).getActionId();

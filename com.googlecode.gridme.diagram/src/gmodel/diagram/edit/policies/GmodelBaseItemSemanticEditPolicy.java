...
import gmodel.Model;
import gmodel.diagram.edit.helpers.GmodelBaseEditHelper;
...
* @generated
*/
public class GmodelBaseItemSemanticEditPolicy extends SemanticEditPolicy
{
  ...
  */
  public Command getCommand(Request request)
  {
    if(request instanceof ReconnectRequest)
    {
      ...
      {
        Integer id = new Integer(GmodelVisualIDRegistry
  ...
  protected Command getSemanticCommand(IEditCommandRequest request)
  {
    ...
    if(elementType != null)
    {
      if(semanticCommand != null)
      {
        ...
        completedRequest.setParameter(GmodelBaseEditHelper.EDIT_POLICY_COMMAND,
            command);
      }
  ...
  */
  public static class LinkConstraints
  {
    ...
    * @generated
    */
    public static boolean canCreateLink_4002(Model container,
        Connection source, GridElement target)
    {
    ...
    * @generated
    */
    public static boolean canExistLink_4002(Model container, Connection source,
        GridElement target)
    {

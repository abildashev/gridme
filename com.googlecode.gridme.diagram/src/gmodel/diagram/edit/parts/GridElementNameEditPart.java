...
import gmodel.diagram.edit.policies.GmodelTextSelectionEditPolicy;
...
* @generated
*/
public class GridElementNameEditPart extends CompartmentEditPart implements
    ITextAwareEditPart
{
  ...
  * @generated
  */
  public GridElementNameEditPart(View view)
  {
    super(view);
  }
  ...
  */
  protected Image getLabelIcon()
  {
    ...
    return GmodelElementTypes.getImage(parserElement.eClass());
  }
  ...
  */
  public void setLabelText(String text)
  {
    ...
    if(pdEditPolicy instanceof GmodelTextSelectionEditPolicy)
    {
      ((GmodelTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
    }
  }
  ...
  public IParser getParser()
  {
    if(parser == null)
    {
      ...
      IAdaptable hintAdapter = new GmodelParserProvider.HintAdapter(
          GmodelElementTypes.GridElement_2002, getParserElement(), parserHint);
  ...
  protected DirectEditManager getManager()
  {
    if(manager == null)
    {
      setManager(new TextDirectEditManager(this, TextDirectEditManager
          .getTextCellEditorClass(this), GmodelEditPartFactory

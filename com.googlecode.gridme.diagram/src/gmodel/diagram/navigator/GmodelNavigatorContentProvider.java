...
* @generated
*/
public class GmodelNavigatorContentProvider implements ICommonContentProvider
{
  ...
  * @generated
  */
  public GmodelNavigatorContentProvider()
  {
  ...
  */
  public Object[] getChildren(Object parentElement)
  {
    ...
    if(parentElement instanceof GmodelNavigatorGroup)
    {
      GmodelNavigatorGroup group = (GmodelNavigatorGroup) parentElement;
      return group.getChildren();
    }

    if(parentElement instanceof GmodelNavigatorItem)
    {
      GmodelNavigatorItem navigatorItem = (GmodelNavigatorItem) parentElement;
  ...
  */
  private Object[] getViewChildren(View view, Object parentElement)
  {
    switch(GmodelVisualIDRegistry.getVisualID(view))
    {
      ...
      {
        Collection result = new ArrayList();
        GmodelNavigatorGroup outgoinglinks = new GmodelNavigatorGroup(
            Messages.NavigatorGroupName_Connection_2001_outgoinglinks,
            "icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
        Collection connectedViews = getOutgoingLinksByType(Collections
            .singleton(view), LinkEditPart.VISUAL_ID);
      ...
      {
        Collection result = new ArrayList();
        GmodelNavigatorGroup incominglinks = new GmodelNavigatorGroup(
            Messages.NavigatorGroupName_GridElement_2002_incominglinks,
      ...
      {
        Collection result = new ArrayList();
        GmodelNavigatorGroup target = new GmodelNavigatorGroup(
            Messages.NavigatorGroupName_Link_4002_target,
            "icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
        GmodelNavigatorGroup source = new GmodelNavigatorGroup(
            Messages.NavigatorGroupName_Link_4002_source,
            "icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
        Collection connectedViews = getLinksTargetByType(Collections
            .singleton(view), GridElementEditPart.VISUAL_ID);
  ...
  */
  ...
  {
    Collection result = new ArrayList();
    String type = GmodelVisualIDRegistry.getType(visualID);
  ...
  */
      ...
      boolean isLeafs)
  {
    ...
    for(Iterator it = views.iterator(); it.hasNext();)
    {
      result.add(new GmodelNavigatorItem((View) it.next(), parent, isLeafs));
    }
    return result;
  }

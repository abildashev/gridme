...
public class GexperimentSwitch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case GexperimentPackage.SINGLE_RUN_RESULT:
      {
        SingleRunResult singleRunResult = (SingleRunResult)theEObject;
        T result = caseSingleRunResult(singleRunResult);
        if (result == null) result = caseRunResult(singleRunResult);
        if (result == null) result = caseNamed(singleRunResult);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case GexperimentPackage.GROUP_RUN_RESULT:
      {
        GroupRunResult groupRunResult = (GroupRunResult)theEObject;
        T result = caseGroupRunResult(groupRunResult);
        if (result == null) result = caseRunResult(groupRunResult);
        if (result == null) result = caseNamed(groupRunResult);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Single Run Result</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Single Run Result</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseSingleRunResult(SingleRunResult object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Group Run Result</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Group Run Result</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseGroupRunResult(GroupRunResult object)
  {
    return null;
  }

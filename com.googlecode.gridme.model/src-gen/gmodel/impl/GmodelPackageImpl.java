...
public class GmodelPackageImpl extends EPackageImpl implements GmodelPackage
{
   ...
   * 
   * <p>This method is used to initialize {@link GmodelPackage#eINSTANCE} when that field is accessed.
  ...
  public static GmodelPackage init()
  {
    ...
    GmodelPackageImpl theGmodelPackage = (GmodelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GmodelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GmodelPackageImpl());
    ...
    EPackage.Registry.INSTANCE.put(GmodelPackage.eNS_URI, theGmodelPackage);
